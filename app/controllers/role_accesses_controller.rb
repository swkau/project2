class RoleAccessesController < ApplicationController
  ...
  private
    ...
    def role_access_params
      params.require(:role_access).permit(:name, :lead_c, :lead_r, :lead_u, :lead_d, :account_c, :account_r, :account_u, :account_d, :opportunity_c, :opportunity_r, :opportunity_u, :opportunity_d, :contact_c, :contact_r, :contact_u, :contact_d, :case_c, :case_r, :case_u, :case_d)
    end
end
