...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { desc: @opportunity.desc, name: @opportunity.name, stage: @opportunity.stage, status: @opportunity.status, value: @opportunity.value }
    end
  ...
  test "should update opportunity" do
    patch :update, id: @opportunity, opportunity: { desc: @opportunity.desc, name: @opportunity.name, stage: @opportunity.stage, status: @opportunity.status, value: @opportunity.value }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
